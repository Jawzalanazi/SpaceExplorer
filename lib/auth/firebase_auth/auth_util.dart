...
DocumentReference? get currentUserReference =>
    loggedIn ? UserDetaRecord.collection.doc(currentUser!.uid) : null;

UserDetaRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UserDetaRecord.getDocument(UserDetaRecord.collection.doc(uid))
              .handleError((_) {}),
    )
